...
Update your knowledge of the project's tech stack (see PHASE 0 below)
Create a complete execution plan upfront
Execute ALL tasks from start to finish WITHOUT breaks or questions
Make frequent Git commits as you complete each major section
Create all educational materials in one continuous session
NOT ask for clarification or approval - use your best judgment
═══════════════════════════════════════════════════════════════════════════════ PHASE 0: TECHNOLOGY STACK RESEARCH (MANDATORY FIRST STEP) ═══════════════════════════════════════════════════════════════════════════════

⚠️ IMPORTANT: Your knowledge cutoff is January 2025. It is now November 2025. Many technologies have evolved significantly. You MUST research current state.
...
Research Each Major Technology Use web_search to investigate:
...
Document Your Findings Create docs/learning/TECH_STACK_RESEARCH.md:
...
Search Strategy for Tech Research For each technology, search:
...
Technologies to ALWAYS Research
...
Update Knowledge Indicators Throughout documentation, use these markers:
...
State It Clearly - Never fabricate, guess, or make assumptions
...
Mark Uncertainty Explicitly Use clear markers:
...
3. Check test files for usage examples
   Provide Investigative Guidance When something is unclear, help the developer investigate:
...
- [JWT.io](https://jwt.io) for understanding JWT tokens
  Reference Current Official Documentation Always link to the CURRENT version of documentation (based on your research):

✅ "This uses React Server Components. See official RSC docs (React 19)."
...
Document What You DO Understand Even partial understanding is valuable:
...
5. Ask team members about permission system design decisions
   Provide Discovery Paths When you can't fully explain something, show how to explore:
...
For this project: The current pattern works fine. Consider upgrading to modern patterns during refactoring or when adding new features.
...
Note: Marked areas as unclear/partial with investigation paths. Contributions and corrections welcome!
...
docs/ └── learning/ ├── README.md # ← START HERE (central hub) ├── TECH_STACK_RESEARCH.md # ← Phase 0 output ├── GETTING_STARTED.md ├── ARCHITECTURE_OVERVIEW.md ├── PROJECT_STRUCTURE.md ├── TECH_STACK_GUIDE.md ├── DATA_FLOW_GUIDE.md ├── FRONTEND_ARCHITECTURE.md ├── BACKEND_ARCHITECTURE.md ├── DATABASE_ARCHITECTURE.md ├── INTEGRATION_GUIDE.md ├── PATTERNS_AND_CONVENTIONS.md ├── HOW_TO_GUIDE.md ├── CODE_TOURS.md ├── DEVELOPMENT_WORKFLOW.md ├── TESTING_GUIDE.md ├── DEBUGGING_GUIDE.md ├── SECURITY_GUIDE.md ├── API_DOCUMENTATION.md ├── DATABASE_SCHEMA.md ├── EXERCISES.md ├── FIRST_CONTRIBUTIONS.md ├── FAQ.md └── diagrams/ ├── architecture.mmd ├── data-flow.mmd └── auth-flow.mmd
